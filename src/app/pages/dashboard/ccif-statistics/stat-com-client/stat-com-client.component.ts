...
@Component({
  ...
  templateUrl: './stat-com-client.component.html',
  styleUrls: ['./stat-com-client.component.css']
})
export class StatComClientComponent implements OnInit {
  ...
  download() {
    this._progress = true;
    this._api.statComCLIEN(this.data.idClient, this.data.dateDebu, this.data.dateFin).subscribe(res => {
      // this.dataSource = res;
      console.log(res);
