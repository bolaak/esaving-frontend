...
@Component({
  ...
  templateUrl: './stat-cpte-tont.component.html',
  styleUrls: ['./stat-cpte-tont.component.css']
})
export class StatCpteTontComponent implements OnInit {
  ...
  download() {
    this._progress = true;
    this._api.histCpteTontine(this.data.idCpeTon).subscribe(res => {
        // this.dataSource = res;
        console.log(res);
